...
|-----------|-----------|----------|
| **Brutally minimal** | Maximum reduction, only what's necessary, stark white space | Productivity, tools, developer products |
| **Luxury / refined** | Restrained palette, editorial spacing, high craft | Finance, fintech, premium SaaS |
| **Art deco / geometric** | Strong geometry, symmetry, ornamental precision | Finance, legal, high-end brand |
| **Editorial / magazine** | Bold type, unexpected crops, mixed scale | Content, media, publishing |
| **Retro-futuristic** | Nostalgia + tech, neon on dark, grid lines | Gaming, AI, developer tools |
| **Organic / natural** | Soft edges, earthy palette, hand-crafted feel | Health, wellness, food, education |
| **Playful / toy-like** | Rounded shapes, vivid saturated color, bouncy motion | Consumer apps, kids, social |
| **Maximalist chaos** | Dense information, layered elements, controlled noise | Creative tools, music, art |
| **Brutalist / raw** | Exposed structure, monospace, harsh contrast | Developer tools, portfolios, agencies |
| **Soft / pastel** | Low saturation, gentle contrast, approachable | Lifestyle, journaling, consumer wellness |
| **Industrial / utilitarian** | Functional grid, no decoration, data-dense | Analytics, dashboards, admin panels |

### Context-Aware Recommendations

| Product type | Recommended directions |
|---|---|
| Finance / fintech | Luxury/refined · Art deco · Brutally minimal |
| Productivity / tools | Brutally minimal · Industrial · Brutalist |
| Social / consumer | Playful · Maximalist · Soft/pastel |
| Education | Editorial · Organic · Retro-futuristic |
| Health / wellness | Organic · Soft/pastel · Brutally minimal |
| Gaming / entertainment | Retro-futuristic · Maximalist · Playful |
| Analytics / admin | Industrial · Brutally minimal · Editorial |

### Terminology to Reject
...
- [ ] **Spec declared:** Purpose, Aesthetic direction, Color palette (hex codes + roles), Typography (font names), Layout strategy all written out
- [ ] **Font audit:** No generic fonts (Inter, Roboto, Arial, Helvetica, system-ui) used without deliberate reason matching the aesthetic direction
- [ ] **Layout audit:** Layout is not a default centered-stack; asymmetry, diagonal, overlap, or grid-breaking is present where appropriate
- [ ] **Color audit:** One color clearly dominates; accent is used sparingly and has visual weight; colors are not evenly distributed
- [ ] **Background audit:** Background has depth (gradient, texture, noise, or layered elements) — not a flat solid color
- [ ] **Terminology audit:** No vague descriptors ("modern", "clean", "simple") in spec or output — only concrete aesthetic directions
- [ ] **Aesthetic consistency:** All screens/components share the same declared aesthetic direction — no mixing of unrelated styles
- [ ] **Code matches spec:** Implemented colors, fonts, and layout strategy match the specification declared at the start